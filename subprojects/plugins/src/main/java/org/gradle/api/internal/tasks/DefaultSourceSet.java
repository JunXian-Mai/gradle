...
public abstract class DefaultSourceSet implements SourceSet {
    ...
    public DefaultSourceSet(String name, ObjectFactory objectFactory) {
        ...
        resources.getFilter().exclude(new ExcludeJavaSourceSpec(javaSource));
    ...
    private static class ExcludeJavaSourceSpec implements Spec<FileTreeElement> {
        private final FileCollection javaSourceCollection;

        public ExcludeJavaSourceSpec(FileCollection javaSourceCollection) {
            this.javaSourceCollection = javaSourceCollection;
        }

        @Override
        public boolean isSatisfiedBy(FileTreeElement element) {
            return javaSourceCollection.contains(element.getFile());
        }
    }
}
